...
const toTimeUnitPhrase = (timeUnitValue, unitIndex) => {
  const unitLabel = timeUnitValue === 1 ? (0, import_i18n.t)(UnitLabels[unitIndex].singular) : (0, import_i18n.t)(UnitLabels[unitIndex].plural);
...
const formatAsTimePhrase = (seconds) => {
  ...
  if (negative) {
    return (0, import_i18n.t)("{time} remaining", { time: timeString });
  }
  return timeString;
};

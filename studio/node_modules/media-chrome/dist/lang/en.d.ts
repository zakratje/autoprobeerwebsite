export declare const En: {
    ...
    readonly '{time} remaining': "{time} remaining";
    readonly '{currentTime} of {totalTime}': "{currentTime} of {totalTime}";
    readonly 'video not loaded, unknown time.': "video not loaded, unknown time.";
};
